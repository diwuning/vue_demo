<template>
    <div style="background-color: black;padding: 20px">
        <canvas class="box" id="show" width="300px" height="200px"></canvas>
...
<script>
    export default {
        ...
        mounted() {
            this.getParamColor('rgb(31,62,255)');
            this.initData();
            this.getDotList();
        },
        methods:{
            ...
            initData() {
                ...
                if (show.getContext) {//首先判断getcontext方法是否存在，这是一个良好的习惯
                    ...
                    // gradientBar.addColorStop(0, '#ff0000');
                    // gradientBar.addColorStop(1 / 3, '#00ff00');
                    // gradientBar.addColorStop(2 / 3, '#0000ff');
                    // gradientBar.addColorStop(1, '#ff0000');
