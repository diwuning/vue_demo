<template>
  <div class="container">
    <div><img src="../../assets/logo.png" style="width:20px; height: 20px; transform: rotate(90deg); display: flex" @click="goBack()"></div>
  ...
  methods: {
    ...
    formatPrizeList (list) {
      ...
      list.forEach((item, i) => {
        ...
        console.log('formatPrizeList', angle)
        // 增加 style
...
.lucky-wheel {
  width: 100%;
  background: rgb(252, 207, 133) url("../../assets/lottery/color_pillar.png") no-repeat
    center bottom;
  background-size: 100%;
  padding-top: 20px;
}
